...
uint32_t UNKNOWNFLOAT4; // Unknown float
uint32_t UNKNOWNFLOAT5; // Unknown float
uint32_t UNKNOWNFLOAT6; // Unknown float
uint32_t UNKNOWNFLOAT7; // Unknown float
uint32_t UNKNOWNFLOAT8; // Unknown float
uint32_t UNKNOWNFLOAT9; // Unknown float
